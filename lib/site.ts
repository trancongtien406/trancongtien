export const siteConfig = {
  ...
  description:
    "Studio kỹ thuật sản phẩm giúp startup và doanh nghiệp biến ý tưởng thành sản phẩm số thực tế — từ khám phá, thiết kế đến phát triển Web, Mobile, AI & Cloud.",
...
export const footerLinks = {
  ...
  projects: [
    ...
    { href: "/du-an?cat=ai", label: "AI Solution" },
  ],
  resources: [
    { href: "/blog", label: "Blog" },
